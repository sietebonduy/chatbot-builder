...
const Navbar = () => {
  ...
  return (
    <div
      ref={navbarRef}
      className={`navbar bg-slate-50 text-gray-900 shadow border-b px-10 py-3 fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${
    ...
    >
      <div className="flex-1">
        <span
          onClick={() => navigate('/')}
          className="text-2xl font-semibold tracking-wide cursor-pointer hover:text-gray-500 transition"
        >
          {t('navbar.app_name')}
        </span>
      </div>
